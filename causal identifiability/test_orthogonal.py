...
Usage:
    python test_orthogonal.py --traits formality politeness humor --n_seeds 5
"""
...
def main():
    ...
    parser.add_argument('--traits', nargs='+', default=['formality', 'politeness', 'humor'],
                       choices=['formality', 'politeness', 'humor'],
                       help='Traits to test')
    ...
    output_file = f"results/orthogonal_test_results_{model_suffix}.json"
